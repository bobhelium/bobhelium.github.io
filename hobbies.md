...
> Lastest Update:26th June 2026&nbsp;  [中文版本 (Chinese Version)]({{ site.url }}/file/hobbies-zh/)
>> This page was generated by automatic translation software, and the [Chinese version]({{ site.url }}/file/hobbies-zh/) of the content is more in line with my actual expression
...
Since 2026, I have also started playing squash. It is competitive, but it does not require a fixed teammate or even another participant for every session. That makes it unusually friendly to someone who wants both exercise and a small private game. I can now keep the ball going for more than a hundred self-fed rallies, which gives me a simple, visible way to measure progress. If you share my interest in fitness, body sculpting, athletic performance, and exercise physiology, I am more than happy to exchange thoughts.
...
My all-time favorite game is actually Overwatch. I have followed and played it since after my college entrance examination. Since Overwatch returned to NetEase, I occasionally play it outside academic work, though my available time is quite limited. I am a support-role specialist, usually ranging from Diamond 1 to Master 5. I can play every support hero and try to help the team with healing, utility, positioning, and tempo control.<br>
